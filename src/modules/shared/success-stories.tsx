...
function SuccessStories() {
  return (
    <section className="w-full py-12 md:py-16 bg-gradient-to-b from-rose-50/50 via-white to-green-50/30">
        ...
        <Carousel
          ...
          renderSlide={(item) => (
            <div className="h-full">
              <div className="relative group h-full bg-gradient-to-br from-[#FFFBF5] to-[#FFFFF0] rounded-2xl overflow-hidden transition-all duration-300 border-2 border-[#F5E6D3] hover:border-[#98BA42] p-6 md:p-8 flex flex-col">
                {/* Star rating */}
                <div className="flex gap-1 mb-4">
                  {[...Array(5)].map((_, i) => (
                    <Star
                      key={i}
                      size={18}
                      className="fill-[#98BA42] text-[#98BA42]"
                    />
                  ))}
                </div>
                ...
                {/* Divider */}
                <div className="w-12 h-1 bg-gradient-to-r from-[#98BA42] to-[#B3243A] rounded-full mb-6" />

                {/* Profile section */}
                <div className="flex items-center gap-4">
                  <div className="relative w-14 h-14 flex-shrink-0">
                    <div className="w-full h-full bg-gradient-to-br from-[#98BA42] to-[#B3243A] rounded-full overflow-hidden border-2 border-white shadow-md">
                      <Image
                        width={56}
                        height={56}
                        alt={item.authorName}
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-[#98BA42] font-medium">
                      Verified Match
                    </p>
                  </div>
                </div>
